package com.apsy2003.todolist

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.widget.Toast
import com.apsy2003.todolist.databinding.ActivityAddTodoBinding
import com.apsy2003.todolist.db.AppDatabase
import com.apsy2003.todolist.db.ToDoDao
import com.apsy2003.todolist.db.ToDoEntity
    ...
    private fun insertTodo() {
        ...
        if (todoImportance == -1 || todoTitle.isBlank()) {
            ...
            Thread {
                ...
                runOnUiThread { // 아래 작업은 UI 스레드에서 실행해주어야 한다.
