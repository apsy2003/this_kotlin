package com.apsy2003.room

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.apsy2003.harusamki.Activity_review

import com.apsy2003.harusamki.databinding.ItemRecyclerBinding
import java.text.SimpleDateFormat

class RecyclerAdapter : RecyclerView.Adapter<RecyclerAdapter.Holder>() {
    //수정을 위해서 MainActivity 연결
    var Activity_review: Activity_review? = null
    ...
    inner class Holder(val binding: ItemRecyclerBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        init {
            ...
            binding.textContent.setOnClickListener {
                Activity_review?.setUpdate(mRoomMemo!!)
            }
