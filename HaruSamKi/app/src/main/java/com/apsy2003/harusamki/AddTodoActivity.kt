...
import com.apsy2003.harusamki.databinding.ActivityAddTodoBinding
...
class AddTodoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.logo.setOnClickListener{ startActivity(logo)}

        //되돌아가기 버튼
        val Back = Intent(this, Activity_ToDoMain::class.java)
