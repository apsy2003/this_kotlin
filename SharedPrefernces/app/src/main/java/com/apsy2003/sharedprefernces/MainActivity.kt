package com.apsy2003.sharedprefernces
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("ShardPref","add_shortcut=${checkboxValue}")
        Log.d("ShardPref","switchValue=${switchValue}")
        Log.d("ShardPref","name=${name}")
        Log.d("ShardPref","selected=${selected}")
    }
}